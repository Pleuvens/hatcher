defmodule HatcherWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HatcherWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HatcherWeb.Gettext, "errors", msg, opts)
    end
  end
